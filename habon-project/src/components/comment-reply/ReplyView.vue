        ...
        <div class="reply-item" v-for="reply in filteredReplies" :key="reply.id">
          ...
          <div v-else>
            ...
            <div class="reply-actions">
              <button class="edit-button" v-if="isLoggedIn && user.id === reply.userId" @click="editReply(reply.id, reply.content)">수정</button>
              <button class="delete-button" v-if="isLoggedIn && user.id === reply.userId" @click="deleteReply(reply.id)">삭제</button>
            </div>
          </div>
        </div>
